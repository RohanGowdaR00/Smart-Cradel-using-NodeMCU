 ...
 *  Version 2.0.0 Blynk&TS - Developed by Rohan Gowda R. 
 *  Date : 29-05-2021 
 *  Department of ECE, MIT college of Engineering Mysore.
 ***************************************/
/* ESP 8266 Library*/
...
char auth[] = "wp7bf3sxX93d6jvz4GLFH9psHdtSIXpA"; //Blynk applications project token code 
